...
assert.match(css, /JBA U12 header reconstruction/);
assert.match(css, /grid-template-columns:100mm 96mm/);
assert.match(css, /grid-template-columns:61mm 35mm/);
assert.match(css, /writing-mode:horizontal-tb/);
assert.match(css, /\.officials label:last-child\{grid-template-columns:26mm minmax\(0,1fr\)\}/);
