...
assert.match(quarterHtml, /第1Q<\/b><span>Quarter 1<\/span>[\s\S]*?<strong>2<\/strong><i>－<\/i><strong>0<\/strong>/);
assert.match(quarterHtml, /第2Q<\/b><span>Quarter 2<\/span>/);
assert.match(quarterHtml, /第3Q<\/b><span>Quarter 3<\/span>/);
assert.match(quarterHtml, /第4Q<\/b><span>Quarter 4<\/span>[\s\S]*?<strong>2<\/strong><i>－<\/i><strong>0<\/strong>/);
